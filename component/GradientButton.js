...
class GradientButton extends React.PureComponent {
  render() {
    ...
    const purpleVioletColor = ["#7B42F6", "#000000"];
    const violetPinkColor = ["#000000", "#000000"];
    const pinkDarkGreenColor = ["#000000", "#205284"];
    const blueVioletColor = ["#3672F8", "#000000"];
    const blueMarineColor = ["#14F1D9", "#3672F8"];
    const deepBlueColor = ["#000000", "#3C46A2"];
    ...
    return (
      ...
      >
        ...
        >
          <Text style={[styles.text, textStyle]}>{text ? text : children} Welcome</Text>
        </LinearGradient>
      </TouchableOpacity>
    );
  }
...
GradientButton.defaultProps = {
  ...
  textStyle: {},
  disabled: false,
  disabledGradientBegin: "#000000",
  disabledGradientEnd: "#000000",
};
